...
if (productId && productsData[productId]) {
  ...
  if (product.status == 'Fora de estoque') {
    content += `
    <section class="mt-20 flex items-start justify-between">
    <div>
      <h1 class="text-2xl font-bold leading-9">${product.produto}</h1>
  
      <div class="flex items-center gap-2">
        <i class='bx bxs-star bx-sm text-yellow-400'></i>
        <i class='bx bxs-star bx-sm text-yellow-400'></i>
        <i class='bx bxs-star bx-sm text-yellow-400'></i>
        <i class='bx bxs-star bx-sm text-yellow-400'></i>
    ...
    <div>
      <span class="text-red-600 font-semibold">${product.status}</span>
    </div>
  </section>
  
  <section class="flex gap-36">
    <div class="flex items-center gap-4">
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="flex items-center gap-5">
          <div class="rounded-full w-5 h-5 bg-violet-500"></div>
          <div class="rounded-full w-5 h-5 bg-zinc-300"></div>
          <div class="rounded-full w-5 h-5 bg-zinc-300"></div>
          <div class="rounded-full w-5 h-5 bg-zinc-300"></div>
        </div>
      </div>
    ...
    <div class="flex flex-col flex-1">
      ...
      <div class="flex items-start justify-between flex-1">
        <div class="flex flex-col items-start">
          <!-- preço e carrinho -->
          <span class="line-through text-zinc-400">R$ ${product.precoSemDesconto}</span>
          <strong class="text-3xl text-violet-500 font-bold">R$ ${product.preco}</strong>
  
          <p class="text-zinc-400/80 text-sm">À vista no PIX com até 10 % de desconto</p>
        </div>
  
        <button
          class="bg-violet-500 text-white py-3 flex items-center justify-center gap-5 px-16 outline-none hover:bg-violet-600 text-sm group focus-within:ring-2 focus-within:ring-violet-400 focus-within:rounded-md rounded-md p-0.5 focus-within:ring-offset-2 cursor-not-allowed disabled:bg-zinc-300"
  ...
  <div>
    <span class="text-green-600 font-semibold">${product.status}</span>
  </div>
</section>
...
<section class="flex gap-36">
  ...
  <div class="flex flex-col flex-1">
    ...
    <div class="flex items-start justify-between flex-1">
      ...
      <button 
        class="bg-violet-500 text-white py-3 flex items-center justify-center gap-5 px-16 outline-none hover:bg-violet-600 text-sm group focus-within:ring-2 focus-within:ring-violet-400 focus-within:rounded-md rounded-md p-0.5 focus-within:ring-offset-2 buy-button"
